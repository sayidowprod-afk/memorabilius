  ...
  return (
    <div style={{ maxWidth: 460, margin: '60px auto' }}>
      <div style={{ background: 'white', borderRadius: 16, padding: 40, boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
        <h1 style={{ fontWeight: 900, fontSize: 28, marginBottom: 8 }}>Connexion</h1>
        <p style={{ color: '#666', marginBottom: 30, fontSize: 14 }}>Content de vous revoir !</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            ...
            <input type="password" required placeholder="Votre mot de passe" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} />
          </div>
