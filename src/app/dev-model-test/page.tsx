...
const MODELS = [
  ...
  { key: 'train29', label: 'train-29 (int8, checkpoint epoch 185, EN COURS D\'ENTRAINEMENT -- dataset x3.7 + sur-echantillonnage)', url: '/models/corners-train29-inprogress.onnx', color: '#27ae60' },
] as const
