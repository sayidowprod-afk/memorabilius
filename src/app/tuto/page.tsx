  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', fontFamily: 'Inter, sans-serif', padding: '0 16px', boxSizing: 'border-box' }}>
      ...
      <div style={{ background: 'var(--card-bg, #fff)', borderRadius: 16, padding: 32, marginBottom: 24, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', borderLeft: '4px solid #003DA6' }}>
        ...
        <p style={{ color: 'var(--text2, #555)', lineHeight: 1.7, marginBottom: 16 }}>Inscrivez-vous gratuitement avec votre email et choisissez un pseudo.</p>
      ...
      <div style={{ background: 'var(--card-bg, #fff)', borderRadius: 16, padding: 32, marginBottom: 24, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', borderLeft: '4px solid #003DA6' }}>
        ...
        <p style={{ color: 'var(--text2, #555)', lineHeight: 1.7, marginBottom: 12 }}>Utilisez notre modèle pré-rempli. Complétez chaque colonne sans modifier l'en-tête.</p>
      ...
      <div style={{ background: 'var(--card-bg, #fff)', borderRadius: 16, padding: 32, marginBottom: 24, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', borderLeft: '4px solid #003DA6' }}>
        ...
        <p style={{ color: 'var(--text2, #555)', lineHeight: 1.7, marginBottom: 16 }}>Dans Google Sheets : <strong>Fichier / Partager / Publier sur le web</strong> → choisissez "Valeurs séparées par des virgules (.CSV)".</p>
      ...
      <div style={{ background: 'var(--card-bg, #fff)', borderRadius: 16, padding: 32, marginBottom: 40, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', borderLeft: '4px solid #003DA6' }}>
        ...
        <p style={{ color: 'var(--text2, #555)', lineHeight: 1.7, marginBottom: 16 }}>Rendez-vous dans votre profil Memorabilius, collez le lien CSV. Votre galerie est générée instantanément !</p>
        <div style={{ borderRadius: 12, overflow: 'hidden', marginBottom: 16, border: '1px solid var(--border, #eee)' }}>
